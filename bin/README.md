...
- **output**: Can be files ending with _.las, _.laz, \*.potree or it can be "stdout". If stdout is specified, a potree format file will be printed directly to the console.
